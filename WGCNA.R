...
library("WGCNA")                      
setwd("")                               
data=read.table("WGCNA inputdata.txt",sep="\t",header=T,check.names=F,row.names=1)     #Read the presentation file

#Delete the normal sample
...
###Delete the sample below the shear line
...
###reading WGCNA_Input_SampleInfo data 
traitData = read.table("WGCNA_Input_SampleInfo.txt",row.names=1,header=T,comment.char = "",check.names=F)
...
minModuleSize = 50      #Number of module genes
...
###Module and trait data heat map
...
###Batch output miRNAsi and module scatter plot
